...
button.addEventListener("click", ()=> {
  let randomQuote = quotes[Math.floor(Math.random()*quotes.length)]; //Вводим переменную и прописываем формулу случайной генерации
  par.style.display = "block"; //задаем стиль, чтобы наши цитаты были видны + прописываем стиль CSS
  par.textContent = randomQuote; //приравниваем содержание абзаца к сгенерированным цитатам
})